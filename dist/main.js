...
#todo-section-bar {
    display: grid;
    grid-template-columns: 80px minmax(0, 1fr) minmax(0, 2fr) minmax(0, 1fr) minmax(0, 1fr) 24px;
    border: solid transparent 3px;
    text-align: left;
    gap: .5rem;
}

#todo-section-bar > div {
    height: 1.5rem;
    display: flex;
...
#todo-section-bar > div:hover {
    background-color: whitesmoke;
}

#todo-section-bar > div:first-child {
    align-items: center;
}
...
li > img {
    ...
    filter: invert(67%) sepia(4%) saturate(19%) hue-rotate(6deg) brightness(97%) contrast(82%);
}
...
li:hover > div:nth-child(4) {
    border-top: solid gray 3px;
    border-bottom: solid gray 3px;
}

#todo-section-bar > .ascending {
    border-bottom: solid gray 3px;
}

#todo-section-bar > .descending {
    border-top: solid gray 3px;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,SAAS;AACb;;AAEA;IACI,cAAc;IACd,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,4BAA4B;IAC5B,8BAA8B;IAC9B,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,sBAAsB;AAC1B;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,4FAA4F;IAC5F,6BAA6B;IAC7B,gBAAgB;IAChB,UAAU;AACd;;AAEA;IACI,cAAc;IACd,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,sBAAsB;IACtB,6BAA6B;AACjC;;AAEA;IACI,4BAA4B;AAChC;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,aAAa;IACb,4FAA4F;IAC5F,gBAAgB;IAChB,mBAAmB;IACnB,UAAU;AACd;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,YAAY;IACZ,mBAAmB;AACvB;;AAEA;IACI,4BAA4B;AAChC;;AAEA;IACI,yCAAyC;IACzC,0FAA0F;AAC9F;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,qBAAqB;IACrB,yBAAyB;IACzB,4BAA4B;AAChC;;AAEA;IACI,wBAAwB;IACxB,4BAA4B;IAC5B,+BAA+B;AACnC;;AAEA;IACI,4BAA4B;IAC5B,gCAAgC;IAChC,mCAAmC;AACvC;;AAEA;IACI,6BAA6B;IAC7B,6BAA6B;IAC7B,WAAW;IACX,iCAAiC;IACjC,oCAAoC;AACxC;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,0BAA0B;IAC1B,6BAA6B;AACjC;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,0BAA0B;AAC9B","sourcesContent":["body {\n    margin: 0;\n}\n\n.section-title {\n    padding: .5rem;\n    font-size: x-large;\n}\n\n#page-container {\n    display: grid;\n    grid-template-rows: auto 1fr;\n    grid-template-columns: 1fr 4fr;\n    text-align: center;\n    height: 100vh;\n}\n\ndialog {\n    text-align: left;\n}\n\n#page-title {\n    grid-column: 1/3;\n    background-color: cyan;\n}\n\n#sidebar {\n    background-color: lightgray;\n}\n\n#main {\n    background-color: lightyellow;\n}\n\nul {\n    list-style: none;\n    padding: 0 20px;\n}\n\nli {\n    border: solid transparent 3px;\n}\n\n#project-list > li {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n\n#todo-section-bar {\n    display: grid;\n    grid-template-columns: 80px minmax(0, 1fr) minmax(0, 2fr) minmax(0, 1fr) minmax(0, 1fr) 24px;\n    border: solid transparent 3px;\n    text-align: left;\n    gap: .5rem;\n}\n\n#todo-section-bar > div {\n    height: 1.5rem;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    box-sizing: border-box;\n    border: solid transparent 3px;\n}\n\n#todo-section-bar > div:hover {\n    background-color: whitesmoke;\n}\n\n#todo-section-bar > div:first-child {\n    align-items: center;\n}\n\n#todo-list {\n    padding: 0;\n}\n\n#todo-list > li {\n    display: grid;\n    grid-template-columns: 80px minmax(0, 1fr) minmax(0, 2fr) minmax(0, 1fr) minmax(0, 1fr) 24px;\n    text-align: left;\n    align-items: center;\n    gap: .5rem;\n}\n\n#todo-list > li > div {\n    word-wrap: break-word;\n}\n\nli > span {\n    padding-left: .5rem;\n    margin-right: auto;\n}\n\n.item-due-date {\n    display: flex;\n    height: 100%;\n    align-items: center;\n}\n\n.selected {\n    background-color: whitesmoke;\n}\n\nli > img {\n    /* https://codepen.io/sosuke/pen/Pjoqqp */\n    filter: invert(67%) sepia(4%) saturate(19%) hue-rotate(6deg) brightness(97%) contrast(82%);\n}\n\nli > img:hover {\n    filter: none;\n}\n\n.due {\n    background-color: red;\n    border-top: solid red 3px;\n    border-bottom: solid red 3px;\n}\n\n.urgent {\n    background-color: yellow;\n    border-top: solid yellow 3px;\n    border-bottom: solid yellow 3px;\n}\n\n.upcoming {\n    background-color: lightgreen;\n    border-top: solid lightgreen 3px;\n    border-bottom: solid lightgreen 3px;\n}\n\n.finished > div {\n    background-color: transparent;\n    text-decoration: line-through;\n    color: gray;\n    border-top: solid transparent 3px;\n    border-bottom: solid transparent 3px;\n}\n\nli:hover {\n    border: solid gray 3px;\n}\n\nli:hover > div:nth-child(4) {\n    border-top: solid gray 3px;\n    border-bottom: solid gray 3px;\n}\n\n#todo-section-bar > .ascending {\n    border-bottom: solid gray 3px;\n}\n\n#todo-section-bar > .descending {\n    border-top: solid gray 3px;\n}"],"sourceRoot":""}]);
// Exports
...
function buildTodoItem(project, todo) {
    ...
    todoDueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(todo.dueDate - timezoneOffset, "MMMM dd, yyyy");//for some reason having a positive offset and then adding wouldn't work?
...
function editTodo(todo, todoItem) {
    ...
    let timezoneOffset = new Date().getTimezoneOffset() * -60000;
    todoItem.getElementsByClassName("item-due-date")[0].textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(todo.dueDate - timezoneOffset, "MMMM dd, yyyy");
...
function highlightUrgency(todo, container) {
    let difference = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.differenceInCalendarDays)(todo.dueDate, new Date()) + 1;
    if (difference <= 0) {
...
class ProjectManager {
    ...
    addTodoToProject(projectId, title, description, dueDate, priority, isFinished = false) {
        ...
        selectedProject.todoList.push(new _Todo_js__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, dueDate, priority, isFinished))
